...
const features = [
  {
    icon: "⚡",
    title: "30s → 1s",
    subtitle: "Gets faster with every use",
    description: "Smart Router learns your patterns. First task takes 30 seconds. Same task later? One second.",
    color: "#f59e0b",
  },
  {
    icon: "🌐",
    title: "Network Effect",
    subtitle: "Everyone makes everyone faster",
    description: "Knowledge Store shares learnings anonymously. The more people use NogicOS, the smarter it gets for all.",
    color: "#3b82f6",
  },
  {
    icon: "🔒",
